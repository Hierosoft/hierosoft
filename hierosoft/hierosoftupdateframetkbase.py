...
class HierosoftUpdateFrameTkBase(ttk.Frame):
    ...
    def __init__(self, parent):
        ...
        self.m_packagesSplitter = ttk.PanedWindow(self.m_packagesTabPanel,
                                                  orient="horizontal")
        ...
        self.m_packagesTabPanel.after_idle(
            lambda: self.m_packagesSplitter.sashpos(0, 229))

        # Setup for m_packagesPanel
        self.m_scrolledWindow1 = tk.Canvas(self.m_packagesPanel)
        self.vbar1 = ttk.Scrollbar(self.m_packagesPanel, orient="vertical",
                                   command=self.m_scrolledWindow1.yview)
        self.hbar1 = ttk.Scrollbar(self.m_packagesPanel, orient="horizontal",
                                   command=self.m_scrolledWindow1.xview)
        self.m_scrolledWindow1.configure(yscrollcommand=self.vbar1.set,
                                         xscrollcommand=self.hbar1.set)

        self.m_scrolledWindow1.grid(row=0, column=0, sticky="nsew", padx=5,
                                    pady=5)
        ...
        self.m_scrolledWindow1.create_window(0, 0, anchor="nw",
                                             window=self.inner_frame1)

        def configure_inner1(event):
            self.m_scrolledWindow1.config(
                scrollregion=self.m_scrolledWindow1.bbox("all"))
        ...
        self.vbar2 = ttk.Scrollbar(self.m_packagePanel, orient="vertical",
                                   command=self.m_scrolledWindow2.yview)
        self.hbar2 = ttk.Scrollbar(self.m_packagePanel, orient="horizontal",
                                   command=self.m_scrolledWindow2.xview)
        self.m_scrolledWindow2.configure(yscrollcommand=self.vbar2.set,
                                         xscrollcommand=self.hbar2.set)

        self.m_scrolledWindow2.grid(row=0, column=0, sticky="nsew", padx=5,
                                    pady=5)
        ...
        self.m_scrolledWindow2.create_window(0, 0, anchor="nw",
                                             window=self.inner_frame2)

        def configure_inner2(event):
            self.m_scrolledWindow2.config(
                scrollregion=self.m_scrolledWindow2.bbox("all"))

        self.inner_frame2.bind("<Configure>", configure_inner2)

        self.m_statusBar = ttk.Label(self, text="", relief="sunken",
                                     anchor="w")
